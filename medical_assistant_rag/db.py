...
def get_db_connection():
    return psycopg2.connect(
        host=os.getenv('POSTGRES_HOST', 'mlopszoomcamp-mlflow-db.cr0224c649s6.ap-southeast-1.rds.amazonaws.com'),
        dbname=os.getenv('POSTGRES_DB', 'mlflow_db'),
        user=os.getenv('POSTGRES_USER', 'mlflow'),
        password=os.getenv('POSTGRES_PASSWORD', 'T7JeJ8I5eihBHJOqHH7b'),
